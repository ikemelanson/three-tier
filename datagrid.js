...
let prefix = "https://script.google.com/macros/s/AKfycbwn8K4UPGcpPEMd_vRhw10VB1T0KL95j8lablCeLTbbpyoV6_s0tA-Ccd5Wh3ViybE/exec"
            ...
            switch (params[2]) {                           // params[2] is the field name 
                case "first_name":                       // validating the first_name field of the employee table  
                    ...
                    if (this.value.length < 2) {
                        this.focus()
                        alert('first name must be at least two chaactes')
                        return
                    }
                default:
            }
